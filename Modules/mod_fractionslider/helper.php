...
class FractionSlider
{
   ...
   public function SetScripts($params) {
   	...
   	$doc->addStyleSheet(JURI::base( true ).'/media/mod_fractionslider/css/fractionslider.css');
   	$doc->addScript(JURI::base( true ).'/media/mod_fractionslider/js/jquery.fractionslider.min.js');
   }
