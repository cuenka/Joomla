...
<div class="span10">
	...
	action="<?php echo JRoute::_('index.php?option=com_firm_order&view=importfirmorders'); ?>">
...
<button><a href="index.php?option=com_firm_order&view=importfirmorders&task=import">IMPORT THIS CONTENT</a></button>
