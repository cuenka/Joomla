...
class Available_assetsModelAircraftlist extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_available_assets');
        $this->setState('params', $params);

        // List state information.
        parent::populateState('a.series', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.series LIKE '.$search.'  OR  a.msn LIKE '.$search.'  OR  a.engines LIKE '.$search.'  OR  a.cabin LIKE '.$search.'  OR  a.lu LIKE '.$search.'  OR  a.company_logo LIKE '.$search.' )');
            }
        }
