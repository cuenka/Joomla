...
<form action="<?php echo JRoute::_('index.php?option=com_available_assets&view=additions'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" >
...
<?php endif;?>
    <h1>Add new aircraft manually</h1>
