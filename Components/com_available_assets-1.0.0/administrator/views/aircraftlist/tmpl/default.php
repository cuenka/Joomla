...
<?php endif;?>
		...
		<table class="table table-striped" id="aircraftformList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'aircraftlist.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_available_assets&task=aircraftform.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->dblink); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->dblink); ?>
				<?php endif; ?>
				</td>
				<td>
