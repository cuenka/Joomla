...
<form action="<?php echo JRoute::_('index.php?option=com_available_assets&view=updates'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
<h1>Update information from exiting aircraft manually</h1>
