    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.manufacturer LIKE '.$search.'  OR  a.avglistprice LIKE '.$search.'  OR  a.type LIKE '.$search.'  OR  a.cmv_oldest LIKE '.$search.'  OR  a.cmv_newest LIKE '.$search.'  OR  a.cmv_change LIKE '.$search.'  OR  a.dlr_oldest LIKE '.$search.'  OR  a.dlr_newest LIKE '.$search.'  OR  a.dlr_change LIKE '.$search.' )');
            }
        }
