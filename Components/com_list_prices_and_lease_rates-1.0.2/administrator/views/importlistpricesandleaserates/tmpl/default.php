...
$document->addStyleSheet('components/com_list_prices_and_lease_rates/assets/css/industry_data_table.css');
...
<div class="span10">
	...
	action="<?php echo JRoute::_('index.php?option=com_list_prices_and_lease_rates&view=importlistpricesandleaserates'); ?>">
...
<button><a href="index.php?option=com_list_prices_and_lease_rates&view=importlistpricesandleaserates&task=import">IMPORT THIS CONTENT</a></button>
