...
/**
 * Methods supporting a list of Supporters records.
 */
class SupportersModelLists extends JModelList
{
        ...
        foreach($items as $item){
			...
			if ( isset($item->category) ) {
				...
				// Get the title of that particular template
					$title = SupportersFrontendHelper::getCategoryNameByCategoryId($item->category);
