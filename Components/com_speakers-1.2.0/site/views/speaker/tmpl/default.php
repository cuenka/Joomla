...
switch ( $this->params->get('TitleFormat')) {
	...
	case 'SurNaJob':
		...
		break;
	case 'NaSurJobCom':
		$TitleFormat= $this->item->name." ". $this->item->surname.", ". $this->item->job_title.", ". $this->item->company;
		if ($this->params->get('ShowSalutation'))
		$TitleFormat=$this->item->salutation." ".$this->item->name." ". $this->item->surname.", ".$this->item->job_title.", ". $this->item->company;
		break;	
	case 'SurNaJobCom':
		$TitleFormat=  $this->item->surname." ". $this->item->name.", ". $this->item->job_title.", ". $this->item->company;
		if ($this->params->get('ShowSalutation')) $TitleFormat=  $this->item->salutation." ".$this->item->surname." ".$this->item->name.", ". $this->item->job_title.", ". $this->item->company;
		break;	
	default:
		$TitleFormat= $this->item->name." ".$this->item->surname.", ".$this->item->job_title;
		break;		
...
?>
<?php if ($this->params->get('SpeakerBackgroundColor')): ?>
...
<div <?php echo $this->params->PositionPhotoSpeakerView;?> >
<img src="<?php echo $this->item->photo; ?>" alt="<?php echo $TitleFormat;?> photo" 
	<?php echo $this->params->PhotoSizeSpeakerView;?> />
</div>
<div id="">
...
<?php if ($this->params->get('ShowNavigation')) echo $this->navigation; ?>

<?php if ($this->params->get('SpeakerBackgroundColor')) echo "</div>"; ?>
