...
$document->addStyleSheet('components/com_allcontacts/assets/css/allcontacts.css');

$user	= JFactory::getUser();
$userId	= $user->get('id');
$listOrder	= $this->state->get('list.ordering');
$listDirn	= $this->state->get('list.direction');
$canOrder	= $user->authorise('core.edit.state', 'com_allcontacts');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_allcontacts&task=contacts.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="contactList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_allcontacts&task=contact.edit&id='.(int) $item->id); ?>">
