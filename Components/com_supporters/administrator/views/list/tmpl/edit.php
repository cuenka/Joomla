...
<form action="<?php echo JRoute::_('index.php?option=com_supporters&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="list-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SUPPORTERS_TITLE_LIST', true)); ?>
        <div class="row-fluid">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('more_information'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('more_information'); ?></div>
			</div>
			<div class="control-group">
