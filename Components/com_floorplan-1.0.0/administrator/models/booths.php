...
/**
 * Methods supporting a list of Floorplan records.
 */
class FloorplanModelBooths extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.boothnumber', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.boothnumber LIKE '.$search.'  OR  a.company LIKE '.$search.' )');
            }
        }
