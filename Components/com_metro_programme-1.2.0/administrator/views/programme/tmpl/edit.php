...
<form action="<?php echo JRoute::_('index.php?option=com_metro_programme&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="programme-form" class="form-validate">
...
<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_METRO_PROGRAMME_TITLE_GENERAL')); ?>
 	<div class="row-fluid">
...
<?php echo JHtml::_('bootstrap.endTab'); ?>
  		...
  		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'information', JText::_('COM_METRO_PROGRAMME_TITLE_INFORMATION')); ?>      
...
<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'speakers', JText::_('COM_METRO_PROGRAMME_TITLE_SPEAKERS')); ?>
			<div class="span6 form-horizontal">
			    <fieldset class="adminform">
					<div class="control-group">
...
<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'break', JText::_('COM_METRO_PROGRAMME_TITLE_BREAK')); ?>
 	<div class="row-fluid">
    	<div class="span6 form-horizontal">
    	  	<fieldset class="adminform">
			<div class="control-group">
