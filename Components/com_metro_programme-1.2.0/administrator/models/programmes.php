...
class Metro_programmeModelProgrammes extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_metro_programme');
    ...
    public function getItems() {
		...
		foreach ($items as $oneItem) {
					$oneItem->style = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_STYLE_OPTION_' . strtoupper($oneItem->style));
			...
			$oneItem->chairman = !empty($textValue) ? implode(', ', $textValue) : $oneItem->chairman;
					...
					$oneItem->chairmanisairportspeaker = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_CHAIRMANISAIRPORTSPEAKER_OPTION_' . strtoupper($oneItem->chairmanisairportspeaker));
			...
			$oneItem->moderator = !empty($textValue) ? implode(', ', $textValue) : $oneItem->moderator;
					...
					$oneItem->moderatorisairportspeaker = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_MODERATORISAIRPORTSPEAKER_OPTION_' . strtoupper($oneItem->moderatorisairportspeaker));
			...
			$oneItem->speaker1 = !empty($textValue) ? implode(', ', $textValue) : $oneItem->speaker1;
					...
					$oneItem->isairportspeaker1 = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_ISAIRPORTSPEAKER1_OPTION_' . strtoupper($oneItem->isairportspeaker1));
			...
			$oneItem->speaker2 = !empty($textValue) ? implode(', ', $textValue) : $oneItem->speaker2;
					...
					$oneItem->isairportspeaker2 = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_ISAIRPORTSPEAKER2_OPTION_' . strtoupper($oneItem->isairportspeaker2));
			...
			$oneItem->speaker3 = !empty($textValue) ? implode(', ', $textValue) : $oneItem->speaker3;
					...
					$oneItem->isairportspeaker3 = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_ISAIRPORTSPEAKER3_OPTION_' . strtoupper($oneItem->isairportspeaker3));
			...
			$oneItem->speaker4 = !empty($textValue) ? implode(', ', $textValue) : $oneItem->speaker4;
					...
					$oneItem->isairportspeaker4 = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_ISAIRPORTSPEAKER4_OPTION_' . strtoupper($oneItem->isairportspeaker4));
			...
			$oneItem->speaker5 = !empty($textValue) ? implode(', ', $textValue) : $oneItem->speaker5;
					...
					$oneItem->isairportspeaker5 = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_ISAIRPORTSPEAKER5_OPTION_' . strtoupper($oneItem->isairportspeaker5));
			...
			$oneItem->speaker6 = !empty($textValue) ? implode(', ', $textValue) : $oneItem->speaker6;
					...
					$oneItem->isairportspeaker6 = JText::_('COM_METRO_PROGRAMME_PROGRAMMES_ISAIRPORTSPEAKER6_OPTION_' . strtoupper($oneItem->isairportspeaker6));
		}
        return $items;
    }
