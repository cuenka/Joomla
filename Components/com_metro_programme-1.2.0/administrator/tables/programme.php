 ...
 */
class Metro_programmeTableprogramme extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__metro_programme', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_metro_programme') && $array['state'] == 1)){
			$array['state'] = 0;
		}
		if($array['id'] == 0){
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_metro_programme.programme.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_metro_programme', 'programme');
            $default_actions = JFactory::getACL()->getAssetRules('com_metro_programme.programme.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_metro_programme.programme.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(JTable $table = null, $id = null) {
        ...
        $assetParent->loadByName('com_metro_programme');
