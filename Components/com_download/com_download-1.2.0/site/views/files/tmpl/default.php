...
<?php if ($this->item) : ?>
    ...
    <div class="item_fields">
        ...
        <ul class="fields_list">
			...
			<?php 
				$uploadPath = 'administrator' . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_download' . DIRECTORY_SEPARATOR . 'images/Downloads' . DIRECTORY_SEPARATOR . $this->item->file;
			?>
			<a href="<?php echo JRoute::_(JUri::base() . $uploadPath, false); ?>" target="_blank"><?php echo $this->item->file; ?></a></li>			<li><?php echo JText::_('COM_DOWNLOAD_FORM_LBL_FILES_WHATBANNER'); ?>:
			<?php echo $this->item->whatbanner; ?></li>
			<li><?php echo JText::_('COM_DOWNLOAD_FORM_LBL_FILES_URL'); ?>:
